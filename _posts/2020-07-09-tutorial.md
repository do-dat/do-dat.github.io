...
If you want to try to use your own ![equation](https://latex.codecogs.com/gif.latex?Q(s;1)), the following code informs you if the fast dynamics of the closed-loop system is robustly stable or not.
